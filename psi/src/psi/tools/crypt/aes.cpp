...
template void aes::generateSubKeys_impl<4u, 10u>(uint8_t[4u * 4u], aes::SubKeys<10u + 1u>&);
// AES-256
...
template void aes::generateSubKeys_impl<8u, 14u>(uint8_t[8u * 4u], aes::SubKeys<14u + 1u>&);
